...
public class SecurityConfig {
     ...
     * Allows the React frontend running on {@code http://localhost:5173}
     * to send authorized requests to the gateway.
     *
     * @return the CORS configuration source applied to incoming requests
     */
    @Bean
